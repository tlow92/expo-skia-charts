...
For web support, you need to configure your bundler to handle React Native web and Skia's CanvasKit. Follow the [@shopify/react-native-skia web setup guide](https://shopify.github.io/react-native-skia/docs/getting-started/web#manual-configuration).
...
Configure your webpack to alias `react-native` to `react-native-web`:
...
- [Getting Started](./intro.md) - Learn the basics
- [LineChart Guide](./charts/line-chart.mdx) - Explore LineChart features
- [Examples](./charts/examples.mdx) - See interactive examples
